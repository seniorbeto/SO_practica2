...
echo "MSH>>MSH>>MSH>>Ejecutando el comando 0"   > myhistory2.res
echo "MSH>>"                                   >> myhistory2.res

echo "myhistory 21" > myhistory3
echo "ERROR: Comando no encontrado"  >myhistory3.res
